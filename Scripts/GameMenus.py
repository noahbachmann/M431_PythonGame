...
class SettingsMenu(Menu):
    ...
    def draw(self):
        ...
        if self.currentTab == "General":
            ...
            self.controlsButtons.append(Button((self.rect.centerx * 1.35, self.rect.midbottom[1] - TILE_SIZE * 1.2),func=Scripts.DataManager.resetHotkeys , icon=UI_Assets.ICON_TRASH))
