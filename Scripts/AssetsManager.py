...
class Audio:
    ...
    COIN_UP.set_volume(0.3)
    LASER_HIGH = pygame.mixer.Sound(os.path.join(AUDIO_PATH, 'laser_high.ogg'))
    ...
    MINIBOSS_SPAWN.set_volume(0.42)
